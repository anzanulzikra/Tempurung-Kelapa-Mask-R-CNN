...
def mobilenetv1_graph(input_image, architecture, stage5=False, train_bn=True):
    assert architecture in ["mobilenetv1_224"]

    # MobileNetV1 as backbone
    mobilenetv1 = MobileNet(
        input_shape=input_image.shape[1:], include_top=False, weights='imagenet')

    C1 = mobilenetv1.get_layer('conv1').output
    C2 = mobilenetv1.get_layer('conv_pw_3_relu').output
    C3 = mobilenetv1.get_layer('conv_pw_5_relu').output
    C4 = mobilenetv1.get_layer('conv_pw_11_relu').output
    C5 = mobilenetv1.get_layer('conv_pw_13_relu').output
...
class MaskRCNN():
    ...
    def build(self, mode, config: Config):
        ...
        elif config.BACKBONE in ["mobilenetv1_224"]:
